                                ...
                                <div class="user-bg"> <img width="100%" alt="user" src="<c:url value="/plugins/images/large/img1.jpg"/>">
                                    <div class="overlay-box">
                                        <div class="user-content">
                                            <a href="<c:url value="/javascript:void(0)"/>"><img src="<c:url value="/plugins/images/users/genu.jpg"/>"
                                    ...
                                    <table class="table" id="example">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Đã hoàn thành</td>
                                                <td>
                                                    <a href="<c:url value="/profile/profile-edit.do"/>" class="btn btn-sm btn-primary">Cập nhật</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>1</td>
